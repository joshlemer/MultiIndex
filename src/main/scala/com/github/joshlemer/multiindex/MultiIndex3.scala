...
trait MultiIndex3[A, B1, B2, B3] extends MultiIndex[A] with MultiIndex3Like[A, B1, B2, B3, MultiIndex3[A, B1, B2, B3]] {
...
trait MultiIndex3Like[A, B1, B2, B3, +This <: MultiIndex3Like[A, B1, B2, B3, This] with MultiIndex3[A, B1, B2, B3]] extends IterableLike[A, This] {
  ...
  def get(b1: B1, b2: B2, b3: B3): List[A] =
    get1MultiSet(b1).intersect(get2MultiSet(b2)).intersect(get3MultiSet(b3)).toList
